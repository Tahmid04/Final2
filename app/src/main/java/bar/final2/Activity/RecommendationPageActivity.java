...
public class RecommendationPageActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        getSupportActionBar().setTitle(LocationPageActivity.City+" , "+ LocationPageActivity.Location);
        editText.setText(LocationPageActivity.City+" , "+ LocationPageActivity.Location);
        //hard-code
        ...
        for(RestaurantInfo RI: LocationPageActivity.RestaurantBase){
            ...
            view.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(RecommendationPageActivity.this, FoodDetailsActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(RecommendationPageActivity.this, RecommendationPageActivity.class);
            startActivity(intent);
